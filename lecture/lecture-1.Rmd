...
Disclaimer: Lab work and class participation can be adjusted at instructer's discretion. While late homeworks will not be accepted for grades, I highly encourage you to complete them and turn them in.   
...
Required textbook: [Garrett Grolemund and Hadley Wickham, R for Data Science](r4ds.had.co.nz)  
...
__there are multiple approaches to solve a problem and all of them lead to the same solution, but chosing the right one for your data at hand is key__ 
